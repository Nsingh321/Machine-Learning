...
def detect_and_predict_mask(frame, faceNet, maskNet):
	...
	''' 
  ->a blob is just a (potentially collection) of image(s) with the same spatial dimensions(x and y coordinates) (i.e., width and height), 
  ->same depth (number of channels), that have all be preprocessed in the same manner.

  # scalefactor= adds a normalization(after mean subtraction we are multiplying the input channels with scaleFactor)
  # mean = we compute mean of r,g,b channels then subtract from their respective channels
